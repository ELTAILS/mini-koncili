    ...
    <body class="bg-slate-100 font-sans text-slate-900 antialiased">
        <main class="flex min-h-screen items-center justify-center p-6">
            <div class="w-full max-w-xl rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-xl shadow-slate-200/80">
                <div class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-sky-100 text-4xl shadow-inner shadow-sky-200/80">
                    🛠️
                </div>

                <p class="text-sm font-semibold uppercase tracking-[0.25em] text-sky-500">Erro 503</p>
                <h1 class="mt-4 text-4xl font-bold text-slate-900">Serviço indisponível</h1>
                <p class="mt-4 text-base leading-7 text-slate-600">
                    O sistema está em manutenção ou sobrecarregado no momento. Tente novamente em alguns instantes.
                </p>
